...
\centering
    ...
    \includegraphics[width=0.5\textwidth]{figures/featureImportance}
    \label{f_imp}}
    \subfloat[Feature Importance Tuned Model]{%
    \includegraphics[width=0.5\textwidth]{figures/featureImportance_tuned}
    \label{f_imp_tuned}}

    \qquad

    \subfloat[Feature Importance Based on Cover]{%
    \includegraphics[width=0.5\textwidth]{figures/featureImportance_cover}
    \label{f_imp}}
    \subfloat[Feature Importance Based on Information Gain]{%
    \includegraphics[width=0.5\textwidth]{figures/featureImportance_informationGain}
    \label{f_imp_tuned}}
