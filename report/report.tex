...
From figures \ref{atct_dimension}, \ref{atcs_dimension}, and \ref{blg_dimension}, I know that these variables are broadly distributed.
...
\begin{figure}[!hbtp]
\centering
    \caption{\textbf{Density estimation for dimension blg. }\textit{Self-reported attitudes about CS class belonging.}}\label{blg_dimension}
    \includegraphics[width=0.7\textwidth]{figures/blg_kde}
\end{figure}
