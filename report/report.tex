...
We created a frequency distribution for some dimensions in our data to see if there are features that have extremely low variability in their distribution. As we 
...
\centering
    ...
    \caption{\textbf{Frequency distribution for dimension atcs: Self-reported attitudes about CS.}}
\end{figure}
