...
\centering
    ...
    \includegraphics[width=0.65\textwidth]{figures/random_forest_CM}
    \label{RFCM}}
    \subfloat[Decision Tree]{%
    \includegraphics[width=0.65\textwidth]{figures/decision_tree_CM}
    \label{DTCM}}
    ...
    \subfloat[XgBoost]{%
    \includegraphics[width=0.65\textwidth]{figures/xgboost_CM}
    \label{XGBCM}}
    \subfloat[SVC]{%
    \includegraphics[width=0.65\textwidth]{figures/svc_CM}
    \label{SVCCM}}
