...
\begin{figure}[!hbtp]
\centering
    \includegraphics[width=0.8\textwidth]{figures/X_graph}
...
Once we performed our search through the hyper-parameter space to find the combination of hyper-parameters that maximized the performance of our classifier, we were able to improve the previous $F_1 0.72\%$ score by SOMETHING\%. Here is the final model for classifying gender in introductory CS. 
\begin{verbatim}
