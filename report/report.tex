...
I am using these two evaluation metrics in tandem because simple accuracy does not distinguish between \textbf{false positive} and \textbf{false negative} rates. Further, the student dataset that I used for this project has unbalanced classes as can be seen in figure \ref{targetClass}. It is important to pay attention to this class unbalance as it can cause the accuracy metric to breakdown as the classes become more skewed.
